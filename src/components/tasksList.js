...
const TasksList = ({id, name, tasks, deleteTask, updateTask, changeDone, deleteList}) => {
    ...
    return (
        <div className="tasks_list" id={id}>
            <h2>
                {name}
                <img className="trash" align="right" title="Видалити список" src={require("../icons/trash24.png")} onClick={deleteListHandler}/>
